...
#' and the estimated variance are lambda_hat = theta_hat * n_new.
#'
...
#'
#' UCL based on n_new and true value of theta
#'
#' @param d Initialized data frame
#' @return data frame with values for ucl_true_theta
...
#'
#' UCL based on n_new and no-pooling estimate of theta
#'
#' @param d Initialized data frame
#' @return data frame with values for ucl_nopool
...
#'
#' UCL based on n_new and complete-pooling estimate of theta
#'
#' @param d Initialized data frame
#' @return data frame with values for ucl_complpool
...
#'
#' UCL based on n_new and partial-pooling estimate of theta
#'
#' @param d Initialized data frame
#' @return data frame with values for ucl_partpool
